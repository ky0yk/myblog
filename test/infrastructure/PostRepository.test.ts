...
describe("PostRepository", () => {
    describe("findById", () => {
        ...
        it("should throw error when findUnique throws error", async () => {
            ...
            await expect(postRepository.findById(testPostData.id)).rejects.toThrow("Test error");
        });
    });
    ...
    describe("save", () => {
        ...
        it("should throw error when upsert throws error", async () => {
            ...
            await expect(postRepository.save(postEntity)).rejects.toThrow("Test error");
        });
    });
    ...
    describe("delete", () => {
        ...
        it("should throw error when delete throws error", async () => {
            ...
            await expect(postRepository.delete(postEntity)).rejects.toThrow("Test error");
        });
    });
});
